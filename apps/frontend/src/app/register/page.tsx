...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8f9fc] px-4 py-12 relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue-50 rounded-full blur-[120px] opacity-60" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-green-50 rounded-full blur-[120px] opacity-60" />
      ...
      <div className="max-w-md w-full bg-white rounded-[40px] shadow-[0_20px_80px_rgba(0,0,0,0.04)] border border-gray-100 p-10 sm:p-14 relative z-10 animate-in fade-in zoom-in-95 duration-500">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-6 py-3.5 bg-gray-50 border border-gray-100 rounded-[22px] text-[15px] focus:outline-none focus:ring-4 focus:ring-blue-500/5 focus:bg-white focus:border-blue-400 transition-all font-medium"
        ...
        <p className="mt-12 text-center text-[14px] text-gray-500 font-medium tracking-tight">
          ...
          <Link href="/login" className="text-blue-600 font-black hover:underline ml-1">
            Log in here
          </Link>
        </p>
      </div>
